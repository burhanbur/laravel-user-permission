      ...
      <div class="card card-primary">
          ...
          <div class="card-body">
          	<div style="padding-bottom: 15px">
		      	<a href="#" value="{{ route('create.permission') }}" title="Add Permission" class="btn btn-success modalCreate" data-target="#modalCreate" data-toggle="modal"><i class="fas fa-user-plus"></i> &nbsp;Add Permission</a>
          	</div>
            ...
            <table id="table" class="table table-bordered table-striped">
              ...
              <tbody>
              	...
              	<tr>
              		...
              		<td class="center">
                    	<a href="#" value="{{ route('edit.permission', $row->id) }}" class="btn btn-info btn-xs modalEdit" title="Edit Permission" data-toggle="modal" data-target="#modalEdit"><span class="fas fa-pencil-alt"></span></a>
                    	<form style="display: inline;" method="POST" action="{{ route('delete.permission', $row->id) }}">
                    		@csrf
                    		@method('DELETE')
